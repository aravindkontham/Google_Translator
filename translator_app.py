...
st.set_page_config(page_title="Google Translator", page_icon="🌍", layout="centered")
...
# Application title
st.markdown("<div class='title-text'>🌐 Google Translator 🌐</div>", unsafe_allow_html=True)
